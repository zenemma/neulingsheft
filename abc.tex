...
\item[Akkreditierung]
    Akkreditierung ist ein standardisiertes und regelmäßiges Verfahren zur Qualitätssicherung in Studium und Lehre. Es steht die Frage im Mittelpunkt, ob der Studiengang gewisse Mindeststandards erfüllt. Die Kriterien umfassen u.a. Studierbarkeit, das Prüfungssystem und Diversität, aber noch viele mehr. Es gibt hauptsächlich zwei verschiedene Arten von Akkreditierung: Die Programmakkreditierung — hier wird das Akkreditierungsverfahren durch eine Agentur durchgeführt — oder die Systemakkreditierung. Die meisten Universitäten sind systemakkreditiert, das heißt, dass sie für die Verfahren selbst verantwortlich sind. Elementar ist in jedem Fall, dass es bei jedem Akkreditierungsverfahren Professor*innen, Vertreter*innen der Berufspraxis und Studierende gibt, die die Akkreditierungskritierien für den Studiengang bewerten. Der Studentische Akkreditierungspool (LINK) schult regelmäßig studentische Gutachter*innen, welchen dann an Akkreditierungsverfahren teilnehmen können.

\item[AK-Tool]
    Es gibt ein Tool, das automatisch einen Zeitplan für die vorgeschlagenen AKs erstellen kann, es basiert auf abgegebenen Präferenzen der Teilnehmenden. (Meist) kurz nach dem Anfangsplenum erhaltet ihr die Möglichkeit, eure Präferenzen auf einer Webseite einzutragen, ihr habt die Wahl zwischen
    \begin{itemize}
        \item Ignore (\enquote{Dieser AK interessiert mich nicht})
        \item Intersted (\enquote{Dieser AK ist interessant für mich, aber ich bin nicht traurig, wenn ich nicht daran teilnehmen kann.})
        \item Great Interest (\enquote{Dieser AK ist interessant für mich und ich bin traurig, wenn ich nicht daran teilnehmen kann.})
        \item Leitung/Required (\enquote{Ich bin die Leitung dieses AK oder unentbehrlich für diesen AK})
    \end{itemize}
    Bitte verwendet Leitung/Required sehr spärlich, weil es dazu führen kann, dass es keinen sinnvollen AK-Plan gibt, wenn es zu oft benutzt wird.
    \emph{Das Tool ist nicht die ganze Nacht verfügbar.} Nach Freischaltung habt ihr ca. \emph{1 Stunde} Zeit.
...
\item[BMFTR]
    Das \enquote{Bundesministeriums für Forschung, Technologie und Raumfahrt} fördert hochschulbezogene Maßnahmen, insbesondere die KoMa, sofern sie in Deutschland stattfinden. Da wir diese Förderung wenn möglich gerne warnehmen, ergeben sich für uns einige Richtlinien, an die wir uns halten müssen. Dazu gehören zum Beispiel die Erstellung eines Tagungsbandes und das genaue Führen von Teilnahmelisten (auch \enquote{BMFTR-Listen} genannt) auf denen täglich alle Teilnehmenden unterschreiben müssen. Genaueres erklärt die Orga am Anfang der Konferenz. Eine Fachschaft, die an der Organisation einer KoMa interessiert ist, sollte zu diesem Thema unbedingt den Förderverein kontaktieren, da dieser für die Kommunikation mit dem BMFTR zuständig ist.
...
\item[KoMa-Caf\acute{e}]
    Der Hauptaufenthaltsraum der von der ausrichtenden Fachschaft zur Verfügung gestellt wird, hier findet ihr beispielsweise
    \begin{itemize}
        \item (meistens) das ewige Frühstück
        \item andere coole Menschis die gerade nicht in AKs sind
    \end{itemize}
    unter Umständen gibt es einen Ruheraum in der Nähe.
...
\item[Laptop-Discouragement]\label{Laptop-Discouragement}
...
\item[Spenden]
    Falls ihr Interesse habt, dem Förderverein etwas zu spenden, könnt ihr euch etwa folgendes überlegen: Wenn ihr auf eine KoMa fahrt und aus einer der Hochschulen kommt, die eure Auslagen erstatten, dann könnt ihr das Geld, das ihr daheim sowieso für Essen ausgegeben hättet, dem Förderverein spenden und damit die Ausrichtung der kommenden KoMata und die Finanzierung von WAch-KoMaTa zu unterstützen.
...
\item[T-Shirts]
    Es werden vom Orga-Team T-Shirts für die Konferenzen bedruckt. Ein T-Shirt ist üblicherweise im Teilnahmebeitrag enthalten, manchmal kann man bei der Anmeldung angeben, dass man weitere T-Shirts möchte.
...
\item[WAchKoMa]
    Moderner Name für „Zwischentreffen“. Es bedeutet „\emph{W}ei\-ter\-füh\-rung	von \emph{A}rbeitskreisen unter \emph{ch}aotischen Verhältnissen der \emph{Ko}nferenz der deutschsprachigen \emph{Ma}thematikfachschaften“.
...
\item[Zwischenplenum]
    Auf der KoMa gibt es zusätzlich zu Anfangs und Endplenum ein Zwischenplenum am Freitagabend.  Dort gibt es Berichte und/oder Diskussionen zu den AKs, die schon stattgefunden haben und Resolutionen. Wenn Fachschaften zu spät anreisen, haben sie hier noch mal die Möglichkeit, sich vorzustellen.
\end{description}
