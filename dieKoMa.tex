...
Aus diesen Gründen gibt es die Konferenz der deutschsprachigen Mathematikfachschaften, kurz KoMa.
...
finden auf jeder Konferenz viele produktive Arbeitskreise statt.

Solche Arbeitskreise tauschen sich beispielsweise über
\begin{itemize}
    \item die Gestaltung von Orientierungswochen/Ersti-Wochen
    \item Fachschaftszeitschriften
    \item die formale oder inhaltliche Ausgestaltung von Studiengängen
    \item Studiengangsakkreditierungen
\end{itemize}
aus.
% TODO: andere BSPe?
...
Daneben haben wir natürlich auch eine Menge Spaß, zum Beispiel bei
langen Abenden in Kneipen, bei Spielen,
