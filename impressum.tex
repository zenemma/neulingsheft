...
Das Heft wurde im Mai 2026 von \mbox{Hanna (TUM)}, \mbox{Jael (Mainz)}, \mbox{Ben (Bonn)}, \mbox{Emma (Bonn)}, \mbox{Moritz} und \mbox{Alexa (Göttingen)} überarbeitet. Insbesondere die Kapitel \enquote{Das ABC der KoMa}, \enquote{Über die KoMa} und \enquote{Einleitung} wurden geändert.
\vspace{1em}
